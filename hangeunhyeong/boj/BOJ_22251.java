...
public class BOJ_22251 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] bit = {0b1110111, 0b0100100, 0b1011101, 0b1101101, 0b0101110, 0b1101011, 0b1111011, 0b0100101, 0b1111111, 0b1101111};
        int answer = 0;
        for(int i = 1; i <= N; i++){
            int a = X;
            int b = i;
            int cnt = 0;
            for(int j = 0; j < K; j++){
                int n = bit[a % 10];   int m = bit[b % 10];
                cnt += Integer.bitCount(n ^ m);
                a /= 10;
                b /= 10;
            }
            if(cnt <= P)
